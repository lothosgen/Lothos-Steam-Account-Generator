...
namespace Hardwareinfo
{
    public static class HardwareInfo
    {
        ...
        /// <returns></returns>
        /// 
        public static String GetProcessorId([Optional] int Amount)
        {
            if (Amount == 0)
            {
            ...
            else
            {
                ...
                foreach (ManagementObject mo in moc)
                {
                    ...
                    Id = mo.Properties["processorID"].Value.ToString().Substring(0, Amount);
                    break;
                }
                return Id;
            }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetMACAddress([Optional] int Amount)
        {
            if (Amount == 0)
            {
            ...
            else
            {
                ...
                foreach (ManagementObject mo in moc)
                {
                    if (MACAddress == String.Empty)
                    {
                        if ((bool)mo["IPEnabled"] == true) MACAddress = mo["MacAddress"].ToString().Substring(0, Amount);
                    }
                    mo.Dispose();
                }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetLocalIPAddress([Optional] int Amount)
        {
            if (Amount == 0)
            {
            ...
            else
            {
                ...
                foreach (var ip in host.AddressList)
                {
                    if (ip.AddressFamily == AddressFamily.InterNetwork)
                    {
                        return ip.ToString().Substring(0, Amount);
                    }
                }
                throw new Exception("No network adapters with an IPv4 address in the system!");
            }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GetBoardProductId([Optional] int Amount)
        {
            if (Amount == 0)
            {
                ManagementObjectSearcher searcher = new ManagementObjectSearcher("root\\CIMV2", "SELECT * FROM Win32_BaseBoard");
            ...
            else
            {
                ...
                foreach (ManagementObject wmi in searcher.Get())
                {
                    try
                    {
                        return wmi.GetPropertyValue("Product").ToString().Substring(0, Amount);
        ...
        public static string GetDefaultIPGateway([Optional] int Amount)
        {
            if (Amount == 0)
            {
            ...
            else
            {
                ...
                foreach (ManagementObject obj in objCol)
                {
                    if (gateway == String.Empty)  // only return MAC Address from first card
                    {
                        ...
                        if ((bool)obj["IPEnabled"] == true)
                        {
                            gateway = obj["DefaultIPGateway"].ToString().Substring(0, Amount);
                        }
                    }
                    //dispose of our object
                    obj.Dispose();
